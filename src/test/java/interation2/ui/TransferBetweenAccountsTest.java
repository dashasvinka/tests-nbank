...
public class TransferBetweenAccountsTest extends BaseUiTest {
    ...
    public void userCanMakeValidTransferTest() {
        Long idFirst = AccountSteps.createAccountAndGetId(SessionStorage.getUser(1).getUsername(), SessionStorage.getUser(1).getPassword());
        Long idSecond = AccountSteps.createAccountAndGetId(SessionStorage.getUser(1).getUsername(), SessionStorage.getUser(1).getPassword());
        ...
        DepositSteps.createDeposit(SessionStorage.getUser(1).getUsername(), SessionStorage.getUser(1).getPassword(), createDepositRequest);
    ...
    public void userCannotTransferMoreThan10000Test() {
        ...
        String amount =  Double.toString(createTransferRequest.getAmount());
        String idRecipientAccount = "ACC" + (createTransferRequest.getReceiverAccountId());
        String idAccount =  Long.toString(createDepositRequest.getId());
